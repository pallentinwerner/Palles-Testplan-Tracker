...
const TestItemRow: React.FC<TestItemRowProps> = ({ item, itemNumber, onStatusChange, onOpenCommentModal }) => {
  return (
    <div className="p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between hover:bg-slate-700/50 transition-colors">
        <div className="flex items-start mb-4 sm:mb-0">
            <div className="flex-shrink-0 w-8 text-sm font-medium text-slate-400 text-right mr-4">{itemNumber}.</div>
        ...
        <div className="flex items-center justify-end sm:justify-start space-x-2 pl-12 sm:pl-4">
            ...
            <div className="flex items-center space-x-1.5">
                <ActionButton
                    ...
                    title="Kommentar"
                    className="text-cyan-300 bg-cyan-900/50 hover:bg-cyan-900 relative"
                >
                    {item.comment ? (
                    ...
                    {item.commentImage && (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 absolute -top-1 -right-1 text-slate-200 bg-indigo-600 rounded-full p-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                ...
                <ActionButton 
                    ...
                    title="Bestanden"
                    className="text-green-300 bg-green-900/50 hover:bg-green-900"
                >
                ...
                <ActionButton 
                    ...
                    className="text-red-300 bg-red-900/50 hover:bg-red-900"
                >
                ...
                <ActionButton 
                    ...
                    className="text-blue-300 bg-blue-900/50 hover:bg-blue-900"
                >
                 ...
                 <ActionButton 
                    ...
                    title="Zurücksetzen"
                    className="text-slate-400 bg-slate-600/50 hover:bg-slate-600"
                >
